...
- (void)initialization{
    ...
    self.pageDotSize = kCycleScrollViewInitialPageControlDotSize;
}
...
- (UIView *)generateDotView{
    ...
    if (self.dotViewClass) {
        ...
        if ([dotView isKindOfClass:[MSAbstractDotView class]]) {
            ((MSAbstractDotView *)dotView).pageDotSize = self.pageDotSize;
            ((MSAbstractDotView *)dotView).backgroundColor = self.dotColor;
            ((MSAbstractDotView *)dotView).pageDotColor = self.dotColor;
            ((MSAbstractDotView *)dotView).currentPageDotColor = self.currentDotColor;
            if ([dotView isKindOfClass:[MSAnimatedDotView class]] && self.dotColor) {
                ((MSAnimatedDotView *)dotView).layer.borderColor = self.dotColor.CGColor;
            }
        }
    } else {
