...
- (instancetype)wzx_objectAtIndex:(NSUInteger)index{
...
- (instancetype)wzx_mutableObjectAtIndex:(NSUInteger)index{
    if(index > self.count -1 || !self.count){
        @try{
...
- (void)wzx_replaceObjectAtIndex:(NSUInteger)index
...
- (void)wzx_insertObject:(id)anObject
    ...
    [self wzx_insertObject:anObject
                   atIndex:index];
}
