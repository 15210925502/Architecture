...
- (void)badgeInit {
    ...
    self.badgeFont      = [UIFont setFontSizeWithValue:12.0];
    self.badgePadding   = [BaseTools adaptedWithValue:5];
    self.badgeMinSize   = [BaseTools adaptedWithValue:6];
    self.badgeOriginX   = self.frame.size.width - self.badge.frame.size.width / 2;
    self.badgeOriginY   = -[BaseTools adaptedWithValue:3];
