...
- (void) loadContent {
    ...
    if (!_label || !_slider) {
        ...
        _label = [[MBSliderLabel alloc] init];
...
- (UIImage *) thumbWithColor:(UIColor *)color {
    ...
    CGSize size = CGSizeMake(68.0 * scale, CGRectGetHeight(self.frame) * scale);
...
- (void)drawLayer:(CALayer *)theLayer inContext:(CGContextRef)theContext{
	...
	// Create Gradient
	CGGradientRef gradient = CGGradientCreateWithColorComponents (colorspace, gradientComponents,gradientLocations, num_locations);
