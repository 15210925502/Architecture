...
static NSInteger const advertScrollViewTitleFont = 11;
...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        ...
        _titleLabel.font = [UIFont setFontSizeWithValue:advertScrollViewTitleFont];
    }
    return _titleLabel;
}
@end
...
- (UILabel *)topLabel {
    if (!_topLabel) {
        ...
        _topLabel.font = [UIFont setFontSizeWithValue:advertScrollViewTitleFont];
    }
    return _topLabel;
}
...
- (UILabel *)bottomLabel {
    if (!_bottomLabel) {
        ...
        _bottomLabel.font = [UIFont setFontSizeWithValue:advertScrollViewTitleFont];
    }
    return _bottomLabel;
}
@end
    ...
    if (self.advertScrollViewStyle == SGAdvertScrollViewStyleMore) {
        ...
        if (self.imageArr.count > indexPath.item) {
            ...
            if ([topImagePath hasPrefix:@"http"]) {
                ...
                cell.topSignImageView.image = [UIImage imageNamed:@"horn_icon"];
            } else {
        ...
        if (self.bottomImageArr.count > indexPath.item) {
        ...
        if (self.imageArr.count > indexPath.item) {
            ...
            if ([imagePath hasPrefix:@"http"]) {
                ...
                cell.signImageView.image = [UIImage imageNamed:@"horn_icon"];
            } else {
        ...
        NoticeModel *model = self.titleArr[indexPath.item];
